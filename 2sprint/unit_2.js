...
let e1 = '3';
let f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1;//В этом случае e1 является строкой , автоматически f1 тоже приравнивается к строке 
//плюс между строками обЪединяет их
...
function t12() {
    let userName = document.querySelector('.i-12-1').value;
    let userSurName = document.querySelector('.i-12-2').value;
    document.querySelector('.out-12').textContent = `Hello ${userName} ${userSurName}`;
}
...
function t15() {
    document.querySelector('.i-15').setAttribute('style', 'border:4px solid red');
...
function t20() {
    // count = count++; // можно сократить count++
