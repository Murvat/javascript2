...
function f3() {
    let a = parseFloat(document.querySelector('.i-31').value);
    let b = parseFloat(document.querySelector('.i-32').value);
    if (a > b) {
...
function f4() {
    ...
    let birthDate = document.querySelector('.i-4').value;
    let age = curYear - birthDate;
    if (age >= 18) {
...
function f8() {
    switch (parseFloat(document.querySelector('.s-8').value)) {
        case 1:
...
function f9() {
    let localeNum = parseInt(document.querySelector('.i-9').value);
    let result;
...
function f10() {
    let optionValue = document.querySelector('.s-100').value;
    document.querySelector('.out-10').innerHTML = optionValue;
}
...
function f11() {
    let optionValue = document.querySelector('.s-110').value;
    document.querySelector('.out-11').innerHTML = optionValue;
...
function f13() {
    let optionValue = document.querySelector('.i-130').value;
    document.querySelector('.out-13').innerHTML = typeof optionValue;
...
function f14() {
    ...
    switch (document.querySelector('.s-143').value) {
        case "+":
...
function f15() {
    ...
    switch (document.querySelector('.s-153').value) {
        case "&&":
            document.querySelector('.out-15').innerHTML = num1 && num2;
        case "||":
            document.querySelector('.out-15').innerHTML = num1 || num2;
