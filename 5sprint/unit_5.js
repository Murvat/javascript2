...
function t1() {
    ...
    document.querySelector('div.out-1').innerHTML = out;
}
...
function t3() {
    ...
    document.querySelector('div.out-3').innerHTML = out;
}
...
function t5() {
    let out = '';
    let renderOut = document.querySelector('div.out-5');
    for (i = 1; i <= 17; i++) {
        if (i % 2 == 0) {
            out += i + '_**';
        } else {
...
function t6() {
    ...
    let iterationCount = document.querySelector('.i-6').value;
...
function t7() {
    ...
    let userNum = document.querySelector('.i-7').value;
    for (i = userNum; i >= 0; i--) {
        out += i + '_';
    }
    renderOut.innerHTML = out;
...
function t8() {
    let biggerNum = +document.querySelector('.i-82').value;
    let simpleNum = +document.querySelector('.i-81').value;
    let out = '';
    let renderOut = document.querySelector('div.out-8');
    for (let i = simpleNum; i <= biggerNum; i++) {
        out += i + '_';
    }
    renderOut.innerHTML = out;
}
...
function t9() {
    ...
    if (num1 > num2) {
        ...
        document.querySelector('div.out-9').innerHTML = out
    } else {
        for (i = num1; i <= num2; i++) {
            out += i + '_';
        };
...
function t10() {
    let renderOut = document.querySelector('.out-10');
    let iterStart = 1950;
    let iterEnd = 1970;
    let out = '';
...
function t13() {
    let inputsArr = document.querySelectorAll('input.i-13');
    for (i = 0; i < inputsArr.length; i++) {
        inputsArr[i].value = i + 1;
    }
}
...
function t15() {
    let out = '';
    let out2 = document.querySelector('div.out-15');
    for (i = 0; i <= 10; i++) {
        out += (10 - i) + '_' + i + '_';
    }
    out2.innerHTML = out;
